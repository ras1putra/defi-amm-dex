...
export const V2_MASTER_CHEF_ABI = [
  {
    type: "function",
    name: "owner",
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_rewarder", type: "address", internalType: "address" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
    name: "addPoolWithRewarder",
    inputs: [
      { name: "_lpToken", type: "address", internalType: "address" },
      { name: "_rewardToken", type: "address", internalType: "address" },
      { name: "_rewardPerSecond", type: "uint256", internalType: "uint256" },
      { name: "_totalRewardCap", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
...
export const GET_PAST_VOTES_ABI = {
  type: "function",
  name: "getPastVotes",
  inputs: [
    { name: "account", type: "address", internalType: "address" },
...
export const V2_GOVERNOR_ABI = [
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct V2Governor.Proposal",
        components: [
          ...
          { name: "status", type: "uint8", internalType: "enum V2Governor.ProposalStatus" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "voteType", type: "uint8", internalType: "uint8" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
